      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-500">
            {category._count.articles} blogpost{category._count.articles !== 1 ? 's' : ''}
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            <Suspense fallback={<div className="h-10 bg-gray-200 rounded-full animate-pulse w-96" />}>
              <CategoryFilter categories={categories} activeCategory={slug} basePath="/blog" />
            </Suspense>
          </div>
          ...
          {articles.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">
                Er zijn nog geen blogposts in deze categorie.
              </p>
            </div>
          )}
          ...
          {pagination.totalPages > 1 && (
            <div className="mt-12 flex justify-center gap-2">
              {Array.from({ length: pagination.totalPages }, (_, i) => i + 1).map((p) => (
                <a
                  key={p}
                  href={`/blog/categorie/${slug}?${query ? `q=${query}&` : ''}page=${p}`}
