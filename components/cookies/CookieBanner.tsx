      ...
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden">
        <div className="p-6">
          <div className="flex items-start gap-4 mb-4">
            ...
            <div>
              <h2 className="text-base font-semibold text-daar-navy mb-1">Wij gebruiken cookies</h2>
          ...
          {showDetails && (
            <div className="mb-4 space-y-3 border-t border-gray-100 pt-4">
              <label className="flex items-center justify-between gap-4">
                <div>
                  <span className="text-sm font-medium text-daar-navy">Noodzakelijk</span>
              ...
              <label className="flex items-center justify-between gap-4 cursor-pointer">
                <div>
                  <span className="text-sm font-medium text-daar-navy">Functioneel</span>
              ...
              <label className="flex items-center justify-between gap-4 cursor-pointer">
                <div>
                  <span className="text-sm font-medium text-daar-navy">Analytisch (Google Analytics)</span>
              ...
              <label className="flex items-center justify-between gap-4 opacity-50">
                <div>
                  <span className="text-sm font-medium text-daar-navy">Marketing</span>
          ...
          <div className="flex flex-wrap gap-2 justify-end">
            <button
              onClick={rejectAll}
              className="px-4 py-2 text-sm text-gray-600 hover:text-daar-navy border border-gray-200 rounded-lg hover:border-gray-300 transition-colors"
            >
              Alleen noodzakelijk
            </button>
            {showDetails ? (
              <button
                ...
                className="px-4 py-2 text-sm bg-daar-navy/10 text-daar-navy rounded-lg hover:bg-daar-navy/20 transition-colors"
              >
                Opslaan
              </button>
            ) : (
